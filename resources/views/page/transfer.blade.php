                            ...
                            <div class="flex-col">
                                <div class="w-24 h-24">
                                    <svg viewBox="0 0 860.1 876.5">
                                        <path class="animate-spin from-blue-300"
                                        ...
                                        <path class="animate-spin from-pink-300"
                                            style="
                                  stroke: black;
                                  stroke-width: 1;
                                ...
                                "
                                        ...
                                        <path class="animate-spin from-yellow-300"
                                            style="
                                  stroke: black;
                                  stroke-width: 1;
                                ...
                                <div class="mt-3 text-gray-200 font-mono text-sm sm:text-xs">Wait process...
                                </div>
                            </div>
                        </div>
                    </template>
